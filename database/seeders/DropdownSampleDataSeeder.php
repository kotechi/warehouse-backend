...
class DropdownSampleDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // 2. Subkategori Aset
        $kategoriAsetTetap = DB::table('kategori_asets')->where('nama_kategori', 'Aset Tetap')->first();
        ...
        // $subkategoriKomputer = DB::table('subkategori_asets')->where('nama_subkategori', 'Peralatan Komputer')->first();
        
        // DB::table('detail_kategori_asets')->insert([
        //     [
        //         'subkategori_aset_id' => $subkategoriKomputer->id,
        //         'kode_detail_kategori' => 'LP',
        ...
        //     [
        //         'kode_entitas' => 'KEMENKEIU',
        //         'nama_entitas' => 'kementerian_lembaga Keuangan',
        ...
        //         'nama_entitas' => 'kementerian_lembaga Dalam Negeri',
        //         'jenis_entitas' => 'kementerian_lembaga',
        ...
        DB::table('penanggung_jawab_asets')->insert([
            [
                'user_id' => 1, // Set jika ada relasi ke user
